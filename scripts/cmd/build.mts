...
const build = async (skipCheck: boolean): Promise<void> => {
  ...
  await logStep({
    ...
    successMessage: 'Linked test/dist/node_modules/ts-fortress',
  });
...
/**
 * Materializes a minimal `test/dist/node_modules/ts-fortress` package (a
...
const ensureDistTestPackageLink = async (): Promise<void> => {
  const packageDir = path.resolve(
    projectRootPath,
    'test/dist/node_modules/ts-fortress',
  );
